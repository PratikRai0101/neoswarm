...
- Image generation, terminal tabs, SSH, and dedicated Git/PR hosting workflows remain roadmap work; local Git inspection/commits and the local artifact workspace are implemented.
