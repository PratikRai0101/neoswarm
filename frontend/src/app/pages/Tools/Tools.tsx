...
const INTEGRATIONS: Integration[] = [
  ...
  },
  {
    id: 'discord',
    name: 'Discord',
    description: 'Read messages, send messages, manage channels, and interact with Discord servers via the NeoSwarm bot.',
...
const Tools: React.FC = () => {
  ...
  const handleSlackAutoConnect = async () => {
    if (!credDialogToolId || !credDialogIntegration) return;
    const slackBridge = (window as any).neoswarm?.connectSlack;
    if (!slackBridge) {
