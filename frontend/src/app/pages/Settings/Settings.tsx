  ...
  const handleConnect = async (providerId: string) => {
    ...
    try {
      ...
      if (data.flow === 'device_code') {
        ...
        // lands on NeoSwarm's own /api/subscriptions/callback endpoint
        ...
        if (useExternal && (window as any).neoswarm?.openExternal) {
          (window as any).neoswarm.openExternal(data.auth_url);
        } else {
