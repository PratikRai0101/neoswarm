    ...
    "Anthropic": [
        {
            ...
            "router_model_id": "cc/claude-sonnet-4-6",
            "api": "anthropic",
            "reasoning": True,
        },
        {
            ...
            "router_model_id": "cc/claude-opus-4-6",
            "api": "anthropic",
            "reasoning": True,
        },
        {
...
# ---------------------------------------------------------------------------
# Model resolution (used by the native AgentLoop path)
# ---------------------------------------------------------------------------
...
def get_available_models(settings: AppSettings) -> dict[str, list[dict]]:
    ...
    for provider_name, models in BUILTIN_MODELS.items():
        ...
        result[provider_name] = [{**m, "configured": configured} for m in models]
...
def get_context_window(
    provider: str, model: str, settings: AppSettings | None = None
) -> int:
